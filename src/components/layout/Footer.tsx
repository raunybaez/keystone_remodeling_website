    ...
    <footer className="bg-slate-800 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">Keystone Remodeling</h3>
          ...
          <div>
            ...
            <address className="not-italic">
              <p className="flex items-start mb-2">
                <svg className="h-6 w-6 mr-2 text-teal-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <p className="flex items-center mb-2">
                ...
                <span className="text-slate-300">(617) 431-6505</span>
              </p>
              <p className="flex items-center">
                <svg className="h-6 w-6 mr-2 text-teal-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-slate-300">raunybaez@gmail.com</span>
              </p>
            </address>
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-slate-700 text-center text-slate-400">
          <p>&copy; {new Date().getFullYear()} Keystone Remodeling. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
